...
def run_test():
    ...
    # Let's double check they extract properly
    pass_throughs = _extract_pass_through_accounts(entities)
    print(f"Verified pass-through extractor logic: Found {len(pass_throughs)} pass-throughs.")
    ...
    # We pass the mock entities explicitly to the newly updated backend engine function!
    run_full_graph_analysis(credentials, session_id, node_label, mock_global_config=entities)
