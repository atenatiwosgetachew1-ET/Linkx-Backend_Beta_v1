...
with psycopg.connect(dsn) as conn:
    with conn.cursor() as cur:
        ...
        cur.execute("INSERT INTO analysis_sessions (session_id, owner_service_id, created_by_type, created_by_id, status) VALUES ('xvigilance-daemon', 999, 'service_account', 999, 'active') ON CONFLICT DO NOTHING")
        conn.commit()
