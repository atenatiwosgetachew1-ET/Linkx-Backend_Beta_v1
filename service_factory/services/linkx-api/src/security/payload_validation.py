...
COMMON_SCHEMAS = {
    ...
    "rule_engine_analysis": {
        ...
        "properties": {
            ...
            "value": {"type": "string", "minLength": 1, "maxLength": 255},
            "session_id": {"type": "string", "maxLength": 128, "pattern": "^[A-Za-z0-9_.:-]+$"},
            "rule_id": {"type": "string", "maxLength": 128, "pattern": "^[A-Za-z0-9_.:-]+$"},
            "frontend_session_id": {"type": "string", "maxLength": 128, "pattern": "^[A-Za-z0-9_.:-]+$"},
            "date": {"type": ["string", "null"], "maxLength": 64},
            "suspicious_reason": {"type": ["string", "null"], "maxLength": 255},
    ...
    "configuration": {
        ...
        "properties": {
            ...
            "rule_name": {"type": ["string", "null"], "maxLength": 255},
            "active_rule": {"type": ["array", "string", "null"], "items": {"type": "string", "maxLength": 255}},
