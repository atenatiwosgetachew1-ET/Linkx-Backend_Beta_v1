...
| `service_factory/services/Linkx_xmaintenance` | Server 4 cleanup services and Neo4j compose assets |
...
cd /opt/linkx-backend-update
sudo git pull
sudo cp service_factory/services/Linkx_xmaintenance/deploy/systemd/linkx-neo4j-backup.service /etc/systemd/system/
sudo cp service_factory/services/Linkx_xmaintenance/deploy/systemd/linkx-neo4j-backup.timer /etc/systemd/system/
sudo systemctl daemon-reload
